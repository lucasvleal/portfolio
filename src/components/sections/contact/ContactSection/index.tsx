        ...
        <Form>
          <FormRow>
            <InputGroup>
              <label htmlFor="name">
                NAME{" "}
                <MontserratText color="tomato" weight="600">
                  *
                </MontserratText>
              </label>
              ...
              <ContainerInput
                ...
                fullfilled={isNameInputFullfilled}
              >
                <FontAwesomeIcon width={14} icon="user" />
            ...
            <InputGroup>
              <label htmlFor="phone">
                PHONE <OptionalInputLabel>(optional)</OptionalInputLabel>
              </label>

              <ContainerInput
                hasError={hasPhoneInputError}
                fullfilled={isPhoneInputFullfilled}
              >
                <FontAwesomeIcon width={14} icon="phone-alt" />
          ...
          <FormRow>
            <InputGroup>
              ...
              <ContainerInput
                ...
                fullfilled={isEmailInputFullfilled}
              >
                <FontAwesomeIcon width={14} icon="envelope" />
